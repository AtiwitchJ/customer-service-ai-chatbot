# latte-csbot-user-v1 - System Architecture
...
flowchart TB
    ...
    subgraph External["External Services"]
        Database["latte-csbot-database<br/>(MongoDB, Supabase)"]
...
# Database (from latte-csbot-database)
...
# Supabase (from latte-csbot-database)
